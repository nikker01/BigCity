...
public class BrandLayout extends FreeLayout {
	...
	public FreeTextView brandTitle;
	public FreeTextView brandArea;
	...
	public BrandLayout(Context context) {
		...
		brandTitle = (FreeTextView) this.addFreeView(new FreeTextView(mContext), 53,
				450, 1000, 50);
		

		brandArea = (FreeTextView) this.addFreeView(new FreeTextView(mContext), 87,
				490, 1000, 40);
