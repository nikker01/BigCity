...
public class MainBrandLayout extends BaseDrawerActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		View activityView = layoutInflater.inflate(
				R.layout.main_brand_tag_layout, null, false);
		frameLayout.addView(activityView);

		context = MainBrandLayout.this;
		...
		getActionBar().setTitle(getResources().getString(R.string.menu_find_brand));
	}
	...
	private void initPagerViewer() {
		...
		for (int i = 0; i < 2; i++) {
			intent[i] = new Intent(context, BrandList.class);
