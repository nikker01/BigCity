...
public class SailsNavigationPopupView {
	
	private SailsTechActivity navigation;
	...
	public SailsNavigationPopupView(SailsTechActivity navigation) {
